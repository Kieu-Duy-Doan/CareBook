...
Route::get('/ajax-search-users', [\App\Http\Controllers\Admin\UserController::class, 'ajaxSearch'])->middleware(['auth'])->name('users.ajax-search');
...
Route::prefix('admin')->name('admin.')->middleware(['auth', 'role:admin,doctor'])->group(function () {
    ...
    Route::prefix('receptionists')->name('receptionists.')->group(function () {
        Route::post('/generate-code', [\App\Http\Controllers\Admin\ReceptionistController::class, 'generateCode'])->name('generate-code');
...
Route::middleware(['auth', 'role:patient'])->prefix('trang-ca-nhan')->name('patient.')->group(function () {
    ...
    Route::get('/don-thuoc/{prescription}/download', [\App\Http\Controllers\Patient\PrescriptionController::class, 'download'])->name('prescriptions.download');
    ...
    // Statistics
    Route::get('/thong-ke', [\App\Http\Controllers\Patient\StatisticController::class, 'index'])->name('statistics.index');
