...
use App\Services\ReceptionistProfileService;

class ReceptionistController extends Controller
{
    protected $receptionistProfileService;

    public function __construct(ReceptionistProfileService $receptionistProfileService)
    {
    ...
    public function store(StoreReceptionistRequest $request)
    {
        ...
        $this->receptionistProfileService->createReceptionist($validated);
    ...
    public function update(UpdateReceptionistRequest $request, $id)
    {
        ...
        $this->receptionistProfileService->updateReceptionist($receptionist, $validated);
