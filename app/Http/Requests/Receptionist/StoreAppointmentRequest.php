...
class StoreAppointmentRequest extends FormRequest
{
    ...
    public function withValidator($validator)
    {
        $validator->after(function ($validator) {
            ...
            // Chặn đặt lịch quá khứ trong ngày
            if ($this->appointment_date === now()->toDateString() && $this->appointment_time) {
                ...
                if ($reqTimeShort < $currentTime) {
                    $validator->errors()->add('appointment_time', 'Không thể đặt lịch khám về thời gian trong quá khứ của ngày hôm nay.');
                }
            }
