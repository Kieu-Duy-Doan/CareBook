    ...
    <div class="space-y-6">
        ...
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center gap-3">
                <a href="{{ route('admin.doctors.export', request()->query()) }}" class="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition flex items-center gap-2">
                ...
                <div class="sm:flex sm:items-start">
                    ...
                    <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                        <h3 class="text-lg leading-6 font-medium text-gray-900" id="modal-title">
                            Import Bác sĩ từ Excel
                        </h3>
                        <div class="mt-2 space-y-4">
                            <p class="text-sm text-gray-500">
                                Tải lên file Excel (.xlsx, .xls) hoặc CSV để thêm hàng loạt bác sĩ vào hệ thống. (Tối đa 10MB)
                            </p>
                            
                            <div class="flex items-center gap-2">
                                <a href="{{ route('admin.doctors.import.template') }}" class="text-sm text-purple-600 hover:text-purple-700 font-medium">
