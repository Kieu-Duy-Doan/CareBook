                            ...
                            <div class="p-6">
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        ...
                                        <input type="text" disabled readonly value="{{ $doctor->doctor_code }}"
                                               class="w-full border border-gray-200 bg-gray-50 text-gray-500 rounded-lg px-4 py-2 font-mono cursor-not-allowed">
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <select name="level" required class="w-full border border-gray-300 rounded-lg focus:ring-purple-500 focus:border-purple-500 px-4 py-2 @error('level') border-red-500 @enderror">
                                            ...
                                            <option value="Bác sĩ Nội khoa" {{ old('level', $doctor->level) == 'Bác sĩ Nội khoa' ? 'selected' : '' }}>Bác sĩ Nội khoa</option>
                                            <option value="Bác sĩ Ngoại khoa" {{ old('level', $doctor->level) == 'Bác sĩ Ngoại khoa' ? 'selected' : '' }}>Bác sĩ Ngoại khoa</option>
                                            <option value="CKI Tim mạch" {{ old('level', $doctor->level) == 'CKI Tim mạch' ? 'selected' : '' }}>CKI Tim mạch</option>
                                            <option value="CKII Tim mạch" {{ old('level', $doctor->level) == 'CKII Tim mạch' ? 'selected' : '' }}>CKII Tim mạch</option>
                                            <option value="Chuyên gia phẫu thuật" {{ old('level', $doctor->level) == 'Chuyên gia phẫu thuật' ? 'selected' : '' }}>Chuyên gia phẫu thuật</option>
                                        </select>
