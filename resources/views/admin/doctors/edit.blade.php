                            ...
                            <div class="p-6">
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div>
                                        ...
                                        <input type="text" name="id_card" value="{{ old('id_card', $doctor->user->id_card) }}"
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div>
                                        ...
                                        <select name="doctor_type" required class="w-full border border-gray-300 rounded-lg focus:ring-purple-500 focus:border-purple-500 px-4 py-2 @error('doctor_type') border-red-500 @enderror">
                                            <option value="clinical" {{ old('doctor_type', $doctor->doctor_type) == 'clinical' ? 'selected' : '' }}>Lâm sàng (Nhận lịch từ khách)</option>
                                            <option value="paraclinical" {{ old('doctor_type', $doctor->doctor_type) == 'paraclinical' ? 'selected' : '' }}>Cận lâm sàng (Siêu âm/Xét nghiệm...)</option>
                                        </select>
