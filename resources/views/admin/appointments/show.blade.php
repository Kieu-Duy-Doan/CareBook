                        ...
                        <div class="grid grid-cols-2 sm:grid-cols-3 gap-6 mb-6">
                            ...
                            <div>
                                ...
                                <div class="text-sm font-medium text-gray-900">
                                    {{ $appointment->created_at->format('d/m/Y H:i') }}</div>
                            </div>
                            <div>
                            ...
                            <div class="flex items-start gap-4 mb-6">
                                ...
                                <div>
                                    <h4 class="text-lg font-bold text-gray-900">
                                        {{ $appointment->patientProfile->full_name }}</h4>
                                    ...
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <div class="font-mono font-bold text-gray-900">
                                                {{ $appointment->patientProfile->health_insurance_number }}</div>
                                        </div>
                                    </div>
                                ...
                                <div class="bg-gray-50 p-3 rounded-lg border border-gray-100 text-center">
                                    ...
                                    <div class="text-lg font-bold text-gray-900">
                                        {{ $appointment->vital_pulse ?? '—' }} <span
                                            class="text-xs font-normal text-gray-500">l/p</span></div>
                                </div>
                                <div class="bg-gray-50 p-3 rounded-lg border border-gray-100 text-center">
                                ...
                                <div class="bg-gray-50 p-3 rounded-lg border border-gray-100 text-center">
                                    ...
                                    <div class="text-lg font-bold text-gray-900">
                                        {{ $appointment->vital_temperature ?? '—' }} <span
                                            class="text-xs font-normal text-gray-500">°C</span></div>
                                </div>
                                <div class="bg-gray-50 p-3 rounded-lg border border-gray-100 text-center">
                                ...
                                <div class="bg-gray-50 p-3 rounded-lg border border-gray-100 text-center">
                                    ...
                                    <div class="text-lg font-bold text-gray-900">
                                        {{ $appointment->vital_weight_kg ?? '—' }} <span
                                            class="text-xs font-normal text-gray-500">kg</span></div>
                                </div>
                                <div class="bg-gray-50 p-3 rounded-lg border border-gray-100 text-center">
                                    ...
                                    <div class="text-lg font-bold text-gray-900">
                                        {{ $appointment->vital_height_cm ?? '—' }} <span
                                            class="text-xs font-normal text-gray-500">cm</span></div>
                                </div>
                                <div class="bg-gray-50 p-3 rounded-lg border border-gray-100 text-center">
                    ...
                    <div class="hidden print:block p-8 border-b-2 border-gray-800 mb-6">
                        ...
                        <div class="mt-6 grid grid-cols-2 gap-4 text-sm">
                            <div><span class="font-medium">Họ tên bệnh nhân:</span>
                                {{ $appointment->patientProfile->full_name ?? '' }}</div>
                            ...
                            <div class="col-span-2"><span class="font-medium">Địa chỉ:</span>
                                {{ $appointment->patientProfile->address ?? '' }}</div>
                            <div class="col-span-2"><span class="font-medium">Chẩn đoán:</span>
                                {{ optional($appointment->medicalRecord)->diagnosis ?? 'Không có thông tin' }}</div>
                        </div>
                    </div>
                            ...
                            <div>
                                ...
                                @if ($appointment->medicalRecord->prescription->notes)
                                    <div class="mt-2 text-xs text-gray-500 italic">* Lời dặn:
                                        {{ $appointment->medicalRecord->prescription->notes }}</div>
                                @endif
                            </div>
                        @else
                    ...
                    <div class="flex items-center gap-4 mb-4">
                        ...
                        <div>
                            <div class="font-bold text-gray-900">
                                {{ $appointment->doctor->full_title ?? 'Chưa chỉ định' }}</div>
