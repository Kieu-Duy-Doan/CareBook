<x-layouts.admin title="Chi tiết Hồ sơ — {{ $profile->full_name }}">
    <div class="space-y-6">
        <!-- Breadcrumbs & Actions -->
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center gap-3">
                ...
                <a href="{{ route('admin.patients.edit', $profile->id) }}" class="px-4 py-2 bg-yellow-500 text-white rounded-lg hover:bg-yellow-600 transition flex items-center gap-2">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-1 space-y-6">
                ...
                <div class="bg-white rounded-lg shadow-sm border border-gray-100 p-5">
                    ...
                    <form action="{{ route('admin.patients.toggle-active', $profile->id) }}" method="POST" onsubmit="return confirm('Hành động này sẽ thay đổi trạng thái của Tài khoản quản lý ({{ $profile->user->full_name }}). Bạn có chắc chắn không?');">
                        @csrf
                        @method('PATCH')
                        @if($profile->user->is_active)
                            ...
                            <div class="flex items-start gap-4">
                                ...
                                <div>
                                    <div class="flex items-center gap-2 mb-1">
                                        <a href="{{ route('admin.appointments.show', $apt->id) }}" class="font-bold text-lg text-blue-600 hover:underline">#{{ $apt->appointment_code }}</a>
