<x-layouts.admin title="Quản lý kịch bản chatbot">
    ...
    @if (session('success'))
        <div class="mb-6 bg-green-50 text-green-800 rounded-xl p-4 flex items-center border border-green-200 shadow-sm"
    ...
    @if (session('error'))
        <div class="mb-6 bg-red-50 text-red-800 rounded-xl p-4 flex items-center border border-red-200 shadow-sm"
            x-data="{ show: true }" x-show="show">
                ...
                <div x-show="open" @click.away="open = false" x-transition:enter="ease-out duration-300"
                    ...
                    <div class="absolute right-0 top-0 pr-5 pt-5">
                        <button type="button" @click="open = false"
                            class="rounded-full bg-gray-50 p-2 text-gray-400 hover:text-gray-600 hover:bg-gray-100 transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
                    ...
                    <form action="{{ route('admin.chatbot.intents.store') }}" method="POST">
                        ...
                        <div class="bg-white px-6 pb-6 pt-8 sm:p-8">
                            <div class="mb-8 flex items-start gap-4">
                                <div
                                    class="flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-blue-50 sm:h-14 sm:w-14">
                                    <i class="fa-solid fa-robot text-xl text-blue-600"></i>
                                </div>
                                <div>
                                    <h3 class="text-2xl font-bold text-gray-900">Thêm kịch bản mới</h3>
                                    <p class="text-sm text-gray-500 mt-1">Định nghĩa một ý định để AI nhận diện và phản
                                        hồi chính xác.</p>
                                </div>
                            </div>
                            ...
                            <div class="space-y-6">
                                <div>
                                    <label class="block text-sm font-bold text-gray-700 mb-2">Tên kịch bản (Mã Intent)
                                    ...
                                    <p class="text-[13px] text-gray-500 mt-2 flex items-center"><i
                                            class="fa-solid fa-circle-info mr-1.5 text-gray-400"></i> Chỉ dùng chữ
                                        thường, số và dấu gạch dưới.</p>
                                </div>

                                <div>
                                    <label class="block text-sm font-bold text-gray-700 mb-2">Mô tả ngắn <span
                                            class="text-red-500">*</span></label>
                                    <input type="text" name="description" required
                                        placeholder="Nhập tóm tắt kịch bản..."
                                        class="w-full rounded-xl border-gray-200 py-3 px-4 text-sm shadow-sm transition-colors focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10">
                                </div>

                                <div>
                                    <label class="block text-sm font-bold text-gray-700 mb-2">Hành động (Action) <span
                                            class="text-red-500">*</span></label>
                                    <div class="relative">
                                        <div
                                ...
                                <div>
                                    <label class="block text-sm font-bold text-gray-700 mb-2">Ví dụ câu hỏi của
                                        khách</label>
                                    ...
                                    <div
                                        class="bg-blue-50/50 rounded-lg p-3.5 mt-3 border border-blue-100 flex items-start">
                                        <i class="fa-solid fa-lightbulb text-blue-500 mt-0.5 mr-2.5"></i>
                                        <p class="text-[13px] text-blue-800 leading-relaxed font-medium">Cung cấp nhiều
                                            mẫu câu khác nhau giúp AI nhận diện tốt hơn. Phân cách các câu bằng ký tự
                                            <code
                                                class="bg-blue-100 text-blue-700 px-1.5 py-0.5 rounded mx-0.5">|</code>
                                            hoặc <code
                                                class="bg-blue-100 text-blue-700 px-1.5 py-0.5 rounded mx-0.5">│</code>.
                                        </p>
                                    </div>
                        ...
                        <div
                            class="bg-gray-50/80 px-6 py-5 border-t border-gray-100 sm:flex sm:flex-row-reverse sm:px-8">
                            <button type="submit"
