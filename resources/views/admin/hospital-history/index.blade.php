<x-layouts.admin title="Lịch sử khám bệnh viện">
    <div class="mb-4 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div class="flex gap-2">
            <a href="{{ route('admin.hospital-history.export-csv') }}?{{ http_build_query(request()->query()) }}"
    ...
    <div class="bg-white p-4 rounded-xl shadow-sm border border-gray-100 mb-6">
        <form action="{{ route('admin.hospital-history.index') }}" method="GET" class="space-y-4">
            <!-- Hàng 1 -->
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <div class="mt-5">
                    <div class="flex gap-2">
                        ...
                        <a href="{{ route('admin.hospital-history.index') }}?clear_filter=1"
    ...
    <div class="flex flex-col sm:flex-row items-center justify-between gap-4 mb-4">
        <div class="text-sm text-gray-600 font-medium">
            Tìm thấy <span class="text-gray-900 font-bold">{{ $appointments->total() }}</span> lịch sử khám
        </div>
    </div>
                ...
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th scope="col"
                            ...
                            sĩ</th>
                        <th scope="col"
                            class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Ngày khám
                        </th>
                        <th scope="col"
