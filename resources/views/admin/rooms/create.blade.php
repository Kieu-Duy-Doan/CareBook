    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
        <form action="{{ route('admin.rooms.store') }}" method="POST">
            ...
            <div class="px-6 py-6 space-y-6">
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6" x-data="{ roomType: '{{ old('room_type', '') }}' }">
                    ...
                    <div x-show="roomType === 'diagnostic'" style="display: none;">
                        ...
                        <input type="number" name="price" value="{{ old('price') }}" min="0" :required="roomType === 'diagnostic'"
