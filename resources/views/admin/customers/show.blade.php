<x-layouts.admin title="Chi tiết Khách hàng — {{ $customer->full_name }}">
    <div class="space-y-6">
        <!-- Breadcrumbs & Actions -->
                            ...
                            @forelse($customer->patientProfiles as $profile)
                                <div class="border border-gray-200 rounded-lg p-4 hover:border-blue-300 transition hover:shadow-sm">
                                    <div class="flex items-start justify-between">
                                        ...
                                        <div>
                                            <a href="{{ route('admin.patients.show', $profile->id) }}" class="px-3 py-1.5 bg-white border border-gray-300 rounded text-sm text-gray-700 hover:bg-gray-50 transition flex items-center gap-1.5 whitespace-nowrap">
