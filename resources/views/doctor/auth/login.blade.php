...
<head>
    ...
    <title>Đăng nhập Bác sĩ - CareBook</title>
...
<body class="font-sans antialiased bg-gray-50 text-gray-900">
    <div class="min-h-screen flex">
        ...
        <div class="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-blue-600 to-indigo-600 text-white p-12 flex-col justify-between">
            <div>
                ...
                <h1 class="text-4xl font-extrabold leading-tight mb-4">
                    Hệ thống quản lý<br>khám chữa bệnh
                </h1>
                <p class="text-blue-100 text-lg">Dành riêng cho đội ngũ y bác sĩ.</p>
            </div>
            ...
            <div class="space-y-6">
                <div class="flex items-start gap-4">
                    ...
                    <div>
                        <h3 class="font-semibold text-lg">Quản lý lịch khám</h3>
                        <p class="text-blue-100 text-sm">Theo dõi và cập nhật lịch hẹn dễ dàng.</p>
                    </div>
                </div>
                <div class="flex items-start gap-4">
                    <div class="bg-white/20 p-3 rounded-lg"><i class="fa-solid fa-microscope text-2xl"></i></div>
                    <div>
                        <h3 class="font-semibold text-lg">Giám sát lâm sàng</h3>
                        <p class="text-blue-100 text-sm">Chỉ định xét nghiệm, kê đơn thuốc nhanh chóng.</p>
                    </div>
                </div>
                <div class="flex items-start gap-4">
                    <div class="bg-white/20 p-3 rounded-lg"><i class="fa-solid fa-file-medical text-2xl"></i></div>
                    <div>
                        <h3 class="font-semibold text-lg">Lịch sử bệnh án</h3>
                        <p class="text-blue-100 text-sm">Tra cứu thông tin sức khỏe bệnh nhân chi tiết.</p>
                    </div>
                </div>
            </div>
        ...
        <div class="w-full lg:w-1/2 flex items-center justify-center p-8 sm:p-12">
            <div class="w-full max-w-md">
                ...
                <div class="mb-8">
                    <h2 class="text-2xl font-bold text-gray-900">Đăng nhập Bác sĩ</h2>
                ...
                <form action="{{ route('doctor.login.post') }}" method="POST" class="space-y-6" x-data="{ loading: false }" @submit="loading = true">
                    @csrf
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <div class="text-sm">
                            <a href="{{ route('doctor.password.request') }}" class="font-medium text-blue-600 hover:text-blue-500">Quên mật khẩu?</a>
                        </div>
                    </div>
