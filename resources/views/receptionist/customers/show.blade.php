    ...
    <div class="space-y-6">
        ...
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center gap-3">
                ...
                <form action="{{ route('receptionist.customers.toggle-active', $customer->id) }}" method="POST" onsubmit="return confirm('Hành động này sẽ thay đổi trạng thái của Tài khoản khách hàng ({{ $customer->full_name }}). Bạn có chắc chắn không?');">
                    @csrf
                    @method('PATCH')
