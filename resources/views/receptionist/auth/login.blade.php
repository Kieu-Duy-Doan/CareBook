...
<head>
    ...
    <title>Đăng nhập Lễ tân - CareBook</title>
...
<body class="font-sans antialiased bg-gray-50 text-gray-900">
    <div class="min-h-screen flex">
        ...
        <div class="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-emerald-600 to-teal-500 text-white p-12 flex-col justify-between">
            <div>
        ...
        <div class="w-full lg:w-1/2 flex items-center justify-center p-8 sm:p-12">
            <div class="w-full max-w-md">
                ...
                <div class="mb-8">
                    <h2 class="text-2xl font-bold text-gray-900">Đăng nhập Lễ tân</h2>
                ...
                <form action="{{ route('receptionist.login.post') }}" method="POST" class="space-y-6" x-data="{ loading: false }" @submit="loading = true">
                    @csrf
                    @if(request()->has('redirect'))
                        <input type="hidden" name="redirect" value="{{ request('redirect') }}">
                    @endif
                    <input type="hidden" name="login_type" value="receptionist">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <div class="text-sm">
                            <a href="{{ route('receptionist.password.request') }}" class="font-medium text-blue-600 hover:text-blue-500">Quên mật khẩu?</a>
                        </div>
                    </div>
