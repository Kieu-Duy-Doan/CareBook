    ...
    <main class="flex-1 relative flex flex-col items-center justify-center p-4 overflow-hidden">
        ...
        <div class="w-full max-w-md bg-white rounded-[2rem] shadow-[0_20px_60px_-15px_rgba(0,0,0,0.1)] border border-slate-100 p-8 sm:p-10 relative z-10">
            <div class="text-center mb-6">
                ...
                <h2 class="text-2xl font-extrabold text-slate-800">Đặt lại mật khẩu</h2>
                <p class="text-sm text-slate-500 mt-2 font-medium">Tạo mật khẩu mới cho tài khoản của bạn</p>
            </div>
            ...
            <form action="{{ route('password.update') }}" method="POST" class="space-y-4"
                ...
                <div>
                    ...
                    <input name="email" type="email" value="{{ $email ?? old('email') }}" required readonly
                        class="block w-full pl-4 pr-4 py-3.5 bg-slate-100 border border-slate-200 rounded-xl text-sm font-medium text-slate-600 cursor-not-allowed">
